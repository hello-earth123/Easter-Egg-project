...
export default class Road3 extends Phaser.Scene {
    ...
    init(data) {
        ...
        const portalSpawnPoints = {
            east: { x: 300, y: 1100 },   // Scene의 east 포탈을 타면 여기서 등장
            south: { x: 850, y: 100 },
            west: { x: 1530, y: 600 },
            north: { x: 800, y: 910 },
        };
    ...
    constructor() {
        ...
        this.safeSpawnPoints = [[700, 230], [823, 550], [900, 700], [1032, 300], [800, 600]];
    }

    // preload() : 유니티의 Awake()와 같이 Scene이 시작되기 전, resource를 로드
    preload() {
        this.load.image("road3", "/static/assets/map/road3.png");
        this.load.tilemapTiledJSON('road3Tile', '/static/assets/map/road3.json');
        // BGM
    ...
    create() {
        ...
        const map = this.add.image(0, 0, "road3").setOrigin(0);
        const tile = this.make.tilemap({ key: 'road3Tile' });
        ...
        this.portals = {
            ...
            west: this.physics.add.sprite(300, 1100, "portal"),
            // south: this.physics.add.sprite(800, 910, "portal"),
            north: this.physics.add.sprite(850, 100, "portal")
        };
