...
export default class MountainEntrance extends Phaser.Scene {
    ...
    preload() {
        this.load.image("MountainEntrance", "/static/assets/map/mountain_enterance.png");
        this.load.tilemapTiledJSON('MountainEntranceTile', '/static/assets/map/mountain_enterance.json');
        // 포탈 PNG 로드
    ...
    create() {
        ...
        const map = this.add.image(0, 0, "MountainEntrance").setOrigin(0);
        const tile = this.make.tilemap({key: 'MountainEntranceTile'});
