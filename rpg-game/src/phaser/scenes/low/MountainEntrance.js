...
export default class MountainEntrance extends Phaser.Scene {
    ...
    constructor() {
        super({ key: "MountainEntrance" });

        this.mapKey = "MountainEntrance";

        this.mapName = "산 초입";      // 맵 이름
        ...
        this.safeSpawnPoints = [[810, 930], [830, 620], [780, 330], [795, 250]];
    }

    // preload() : 유니티의 Awake()와 같이 Scene이 시작되기 전, resource를 로드
    preload() {
        this.load.image("mountain_entrance", "/static/assets/map/mountain_enterance.png");
        this.load.tilemapTiledJSON('mountain_entranceTile', '/static/assets/map/mountain_enterance.json');
        // BGM
        this.load.audio("bgm_mountain_entrance", "/static/assets/sound/background/bgm_mountain_entrance.wav");
    ...
    create() {
        ...
        // 1. 씬 BGM
        this.SoundManager.playBgm("bgm_mountain_entrance")
        ...
        const map = this.add.image(0, 0, "mountain_entrance").setOrigin(0);
        const tile = this.make.tilemap({ key: 'mountain_entranceTile' });
