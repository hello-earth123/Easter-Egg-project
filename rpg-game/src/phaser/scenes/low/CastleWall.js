...
export default class CastleWall extends Phaser.Scene {
    ...
    create() {
        ...
        const introScript = [
            ...
            { cmd: "say", text: "이프리트: \"강력한… 힘을?\"" },
            { cmd: "wait", time: 400 },

            { cmd: "say", text: "그 순간, 스태프가 희미하게 웃은 것 같았다." },
            { cmd: "say", text: "프라가라흐: '자, 소녀여. 우리의 모험을 시작하자고.'" },
            ...
            { cmd: "say", text: "프라가라흐: '몬스터를 잡아 나의 봉인을 풀면, 그 힘의 파편이 너의 힘이 될 것이다.'" },

            { cmd: "say", text: "프라가라흐: 'i를 눌러 인벤토리 창, p를 눌러 너와 나의 능력치 창, k를 눌러 마법 스킬창을 열 수 있다.'" },
            { cmd: "say", text: "프라가라흐: '단축키 슬롯에 스킬과 아이템을 드래그 앤 드롭하여 단축키로 사용할 수 있다.'" },
