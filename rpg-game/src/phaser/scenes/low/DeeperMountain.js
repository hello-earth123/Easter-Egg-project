...
export default class DeeperMountain extends Phaser.Scene {
    ...
    preload() {
        this.load.image("DeeperMountain", "/static/assets/map/deeper_mountain.png");
        this.load.tilemapTiledJSON('DeeperMountainTile', '/static/assets/map/deeper_mountain.json');
        // 포탈 PNG 로드
    ...
    create() {
        ...
        const map = this.add.image(0, 0, "DeeperMountain").setOrigin(0);
        const tile = this.make.tilemap({key: 'DeeperMountainTile'});
