...
export default class SpookyMountain extends Phaser.Scene {
    ...
    preload() {
        this.load.image("SpookyMountain", "/static/assets/map/spooky_mountain.png");
        this.load.tilemapTiledJSON('SpookyMountainTile', '/static/assets/map/spooky_mountain.json');
        // BGM
    ...
    create() {
        ...
        const map = this.add.image(0, 0, "SpookyMountain").setOrigin(0);
        const tile = this.make.tilemap({key: 'SpookyMountainTile'});
