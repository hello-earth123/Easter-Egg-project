...
export default class SpookyMountain extends Phaser.Scene {
    ...
    constructor() {
        super({ key: "SpookyMountain" });

        this.mapKey = "SpookyMountain";

        this.mapName = "음산한 산";    // 맵 이름
        ...
        this.safeSpawnPoints = [[550, 800], [1050, 400], [1050, 400], [550, 800], [800, 600]];
    ...
    preload() {
        this.load.image("spooky_mountain", "/static/assets/map/spooky_mountain.png");
        this.load.tilemapTiledJSON('spooky_mountainTile', '/static/assets/map/spooky_mountain.json');
        // BGM
        this.load.audio("bgm_spooky_mountain", "/static/assets/sound/background/bgm_spooky_mountain.wav");
    ...
    create() {
        ...
        // 1. 씬 BGM
        this.SoundManager.playBgm("bgm_spooky_mountain")
        ...
        const map = this.add.image(0, 0, "spooky_mountain").setOrigin(0);
        const tile = this.make.tilemap({ key: 'spooky_mountainTile' });
        ...
        // 포탈 4개 생성
        this.portals = {
            south: this.physics.add.sprite(800, 1000, "portal"),
            north: this.physics.add.sprite(800, 200, "portal")
        };
    ...
    moveToNextScene(portalId) {
        ...
        // ⭐ 포탈 → 목적지 씬 매핑 테이블
        const portalToScene = {
            south: "DeeperMountain",
            north: "CemeteryEntrance"
        };
