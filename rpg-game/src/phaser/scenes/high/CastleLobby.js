...
export default class CastleLobby extends Phaser.Scene {
    ...
    preload() {
        this.load.image("castle_lobby", "/static/assets/map/castle_lobby.png");
        this.load.tilemapTiledJSON('castle_lobbyTile', '/static/assets/map/castle_lobby.json');
        // BGM
    ...
    create() {
        ...
        const map = this.add.image(0, 0, "castle_lobby").setOrigin(0);
        const tile = this.make.tilemap({ key: 'castle_lobbyTile' });
