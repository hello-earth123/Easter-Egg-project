...
export default class CastleLobby extends Phaser.Scene {
    ...
    constructor() {
        super({ key: "CastleLobby" });

        this.mapKey = "CastleLobby";
    ...
    preload() {
        this.load.image("CastleLobby", "/static/assets/map/castle_lobby.png");
        this.load.tilemapTiledJSON('CastleLobbyTile', '/static/assets/map/castle_lobby.json');
        // 포탈 PNG 로드
    ...
    create() {
        ...
        const map = this.add.image(0, 0, "CastleLobby").setOrigin(0);
        const tile = this.make.tilemap({key: 'CastleLobbyTile'});
    ...
    moveToNextScene(portalId) {
        ...
        // ⭐ 포탈 → 목적지 씬 매핑 테이블
        const portalToScene = {
            east:  "MortuaryRoomEast",
            west:  "CastleInside",
            south: "MortuaryRoomSouth",
            north: "Hall1"
        };
