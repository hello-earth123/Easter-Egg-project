...
export default class RitualRoom extends Phaser.Scene {
    ...
    constructor() {
        super({ key: "RitualRoom" });

        this.mapKey = "RitualRoom";

        this.mapName = "의식실"; // 맵 이름
    ...
    preload() {
        this.load.image("ritual_room", "/static/assets/map/ritual_room.png");
        this.load.tilemapTiledJSON('ritual_roomTile', '/static/assets/map/ritual_room.json');
        // BGM
    ...
    create() {
        ...
        const map = this.add.image(0, 0, "ritual_room").setOrigin(0);
        const tile = this.make.tilemap({ key: 'ritual_roomTile' });
