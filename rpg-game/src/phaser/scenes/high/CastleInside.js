...
export default class CastleInside extends Phaser.Scene {
    ...
    preload() {
        this.load.image("CastleInside", "/static/assets/map/castle_inside.png");
        this.load.tilemapTiledJSON('CastleInsideTile', '/static/assets/map/castle_inside.json');
        // 포탈 PNG 로드
    ...
    create() {
        ...
        const map = this.add.image(0, 0, "CastleInside").setOrigin(0);
        const tile = this.make.tilemap({key: 'CastleInsideTile'});
