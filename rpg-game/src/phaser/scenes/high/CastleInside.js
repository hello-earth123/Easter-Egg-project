...
export default class CastleInside extends Phaser.Scene {
    ...
    constructor() {
        ...
        this.mapKey = "CastleInside";

        this.mapName = "성 안";        // 맵 이름
    ...
    preload() {
        this.load.image("castle_inside", "/static/assets/map/castle_inside.png");
        this.load.tilemapTiledJSON('castle_insideTile', '/static/assets/map/castle_inside.json');
        // BGM
    ...
    create() {
        ...
        const map = this.add.image(0, 0, "castle_inside").setOrigin(0);
        const tile = this.make.tilemap({ key: 'castle_insideTile' });
