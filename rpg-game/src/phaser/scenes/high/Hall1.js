...
export default class Hall1 extends Phaser.Scene {
    ...
    preload() {
        this.load.image("hall1", "/static/assets/map/hall1.png");
        this.load.tilemapTiledJSON('hall1Tile', '/static/assets/map/hall1.json');
        // BGM
    ...
    create() {
        ...
        const map = this.add.image(0, 0, "hall1").setOrigin(0);
        const tile = this.make.tilemap({ key: 'hall1Tile' });
        ...
        // 포탈 4개 생성
        this.portals = {
            east: this.physics.add.sprite(1530, 500, "portal"),
