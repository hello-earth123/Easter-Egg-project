...
export default class MortuaryRoomEast extends Phaser.Scene {
    ...
    constructor() {
        super({ key: "MortuaryRoomEast" });

        this.mapKey = "MortuaryRoomEast";

        this.mapName = "일반 안식실(동)";      // 맵 이름
    ...
    preload() {
        this.load.image("MortuaryRoomEast", "/static/assets/map/mortuary_room_east.png");
        this.load.tilemapTiledJSON('MortuaryRoomEastTile', '/static/assets/map/mortuary_room_east.json');
        // 포탈 PNG 로드
    ...
    create() {
        ...
        const map = this.add.image(0, 0, "MortuaryRoomEast").setOrigin(0);
        const tile = this.make.tilemap({key: 'MortuaryRoomEastTile'});
