...
export default class Hall2 extends Phaser.Scene {
    ...
    constructor() {
        ...
        this.safeSpawnPoints = [[780, 230], [820, 550], [775, 780], [850, 950], [800, 600]];
    ...
    preload() {
        this.load.image("hall2", "/static/assets/map/hall2.png");
        this.load.tilemapTiledJSON('hall2Tile', '/static/assets/map/hall2.json');
        // BGM
    ...
    create() {
        ...
        const map = this.add.image(0, 0, "hall2").setOrigin(0);
        const tile = this.make.tilemap({ key: 'hall2Tile' });
        ...
        this.portals = {
            ...
            north: this.physics.add.sprite(800, 150, "portal")
        };
