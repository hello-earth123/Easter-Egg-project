...
export default class Corridor3 extends Phaser.Scene {
    ...
    constructor() {
        ...
        this.mapKey = "Corridor3";

        this.mapName = "안쪽 복도3";   // 맵 이름
        ...
        this.safeSpawnPoints = [[300, 580], [600, 620], [900, 580], [1200, 620]];
    ...
    preload() {
        this.load.image("corridor3", "/static/assets/map/corridor3.png");
        this.load.tilemapTiledJSON('corridor3Tile', '/static/assets/map/corridor3.json');
        // BGM
    ...
    create() {
        ...
        const map = this.add.image(0, 0, "corridor3").setOrigin(0);
        const tile = this.make.tilemap({ key: 'corridor3Tile' });
