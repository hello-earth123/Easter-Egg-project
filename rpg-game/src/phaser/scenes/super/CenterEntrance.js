...
export default class CenterEntrance extends Phaser.Scene {
    ...
    constructor() {
        super({ key: "CenterEntrance" });

        this.mapKey = "CenterEntrance";

        this.mapName = "성 중앙 입구";        // 맵 이름
    ...
    preload() {
        this.load.image("center_entrance", "/static/assets/map/center_entrance.png");
        this.load.tilemapTiledJSON('center_entranceTile', '/static/assets/map/center_entrance.json');
        // BGM
        this.load.audio("bgm_center_entrance", "/static/assets/sound/background/bgm_center_entrance.wav");
    ...
    create() {
        ...
        // 1. 씬 BGM
        this.SoundManager.playBgm("bgm_center_entrance")
