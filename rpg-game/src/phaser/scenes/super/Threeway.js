...
export default class Threeway extends Phaser.Scene {
    ...
    constructor() {
        ...
        this.mapKey = "Threeway";

        this.mapName = "중앙 복도";       // 맵 이름
    ...
    preload() {
        this.load.image("threeway", "/static/assets/map/threeway.png");
        this.load.tilemapTiledJSON('threewayTile', '/static/assets/map/threeway.json');
        // BGM
    ...
    create() {
        ...
        const map = this.add.image(0, 0, "threeway").setOrigin(0);
        const tile = this.make.tilemap({ key: 'threewayTile' });
        ...
        this.portals = {
            ...
            north: this.physics.add.sprite(820, 100, "portal")
        };
