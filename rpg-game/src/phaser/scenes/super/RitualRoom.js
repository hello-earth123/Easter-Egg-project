...
export default class RitualRoom extends Phaser.Scene {
    ...
    preload() {
        this.load.image("RitualRoom", "/static/assets/map/ritual_room.png");
        this.load.tilemapTiledJSON('RitualRoomTile', '/static/assets/map/ritual_room.json');
        // 포탈 PNG 로드
    ...
    create() {
        ...
        const map = this.add.image(0, 0, "RitualRoom").setOrigin(0);
        const tile = this.make.tilemap({key: 'RitualRoomTile'});
