...
export default class ThroneRoom extends Phaser.Scene {
    ...
    constructor() {
        super({ key: "ThroneRoom" });

        this.mapKey = "ThroneRoom";

        this.mapName = "알현실";         // 맵 이름
    ...
    preload() {
        this.load.image("throne_room", "/static/assets/map/throne_room.png");
        this.load.tilemapTiledJSON('throne_roomTile', '/static/assets/map/throne_room.json');
        // BGM
    ...
    create() {
        ...
        const map = this.add.image(0, 0, "throne_room").setOrigin(0);
        const tile = this.make.tilemap({ key: 'throne_roomTile' });
