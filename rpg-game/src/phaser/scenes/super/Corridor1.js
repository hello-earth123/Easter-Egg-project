...
export default class Corridor1 extends Phaser.Scene {
    ...
    constructor() {
        ...
        this.mapKey = "Corridor1";

        this.mapName = "안쪽 복도1";   // 맵 이름
    ...
    preload() {
        this.load.image("corridor1", "/static/assets/map/corridor1.png");
        this.load.tilemapTiledJSON('corridor1Tile', '/static/assets/map/corridor1.json');
        // BGM
    ...
    create() {
        ...
        const map = this.add.image(0, 0, "corridor1").setOrigin(0);
        const tile = this.make.tilemap({ key: 'corridor1Tile' });
