...
export default class Cemetery4 extends Phaser.Scene {
    ...
    constructor() {
        ...
        this.mapKey = "Cemetery4";

        this.mapName = "공동 묘지4";   // 맵 이름
        ...
        this.safeSpawnPoints = [[400, 1000], [1200, 300], [400, 300], [1200, 400], [800, 600]];
    }

    // preload() : 유니티의 Awake()와 같이 Scene이 시작되기 전, resource를 로드
    preload() {
        this.load.image("cemetery4", "/static/assets/map/cemetery4.png");
        this.load.tilemapTiledJSON('cemetery4Tile', '/static/assets/map/cemetery4.json');
        // BGM
    ...
    create() {
        ...
        const map = this.add.image(0, 0, "cemetery4").setOrigin(0);
        const tile = this.make.tilemap({ key: 'cemetery4Tile' });
