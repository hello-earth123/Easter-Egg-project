...
export default class Cemetery3 extends Phaser.Scene {
    ...
    constructor() {
        ...
        this.safeSpawnPoints = [[400, 1200], [1200, 1100], [900, 600], [1200, 400], [800, 600]];
    }

    // preload() : 유니티의 Awake()와 같이 Scene이 시작되기 전, resource를 로드
    preload() {
        this.load.image("cemetery3", "/static/assets/map/cemetery3.png");
        this.load.tilemapTiledJSON('cemetery3Tile', '/static/assets/map/cemetery3.json');
        // BGM
    ...
    create() {
        ...
        const map = this.add.image(0, 0, "cemetery3").setOrigin(0);
        const tile = this.make.tilemap({ key: 'cemetery3Tile' });
        ...
        this.portals = {
            ...
            north: this.physics.add.sprite(835, 350, "portal")
        };
