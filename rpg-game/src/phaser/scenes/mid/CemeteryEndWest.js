...
export default class CemeteryEndWest extends Phaser.Scene {
    ...
    constructor() {
        super({ key: "CemeteryEndWest" });

        this.mapKey = "CemeteryEndWest";

        this.mapName = "묘지 끝(서)";  // 맵 이름
        ...
        this.safeSpawnPoints = [[400, 900], [1200, 1100], [400, 600], [1200, 400], [800, 600]];
    ...
    preload() {
        this.load.image("cemetery_end_west", "/static/assets/map/cemetery_end_west1.png");
        this.load.tilemapTiledJSON('cemetery_end_westTile', '/static/assets/map/cemetery_end_west1.json');
        // BGM
    ...
    create() {
        ...
        // 1. 씬 BGM
        this.SoundManager.playBgm("bgm_cemetery_end")
        ...
        const map = this.add.image(0, 0, "cemetery_end_west").setOrigin(0);
        const tile = this.make.tilemap({ key: 'cemetery_end_westTile' });
