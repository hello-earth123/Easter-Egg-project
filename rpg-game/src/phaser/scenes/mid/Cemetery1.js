...
export default class Cemetery1 extends Phaser.Scene {
    ...
    constructor() {
        ...
        this.mapKey = "Cemetery1";

        this.mapName = "공동 묘지1";   // 맵 이름
    ...
    preload() {
        this.load.image("cemetery1", "/static/assets/map/cemetery1.png");
        this.load.tilemapTiledJSON('cemetery1Tile', '/static/assets/map/cemetery1.json');
        // BGM
    ...
    create() {
        ...
        const map = this.add.image(0, 0, "cemetery1").setOrigin(0);
        const tile = this.make.tilemap({key: 'cemetery1Tile'});
        ...
        this.portals = {
            ...
            south: this.physics.add.sprite(820, 1100, "portal"),
            north: this.physics.add.sprite(820, 300, "portal")
        };
