...
export default class CemeteryEndNorth extends Phaser.Scene {
    ...
    constructor() {
        ...
        this.mapKey = "CemeteryEndNorth";

        this.mapName = "묘지 끝(북)";  // 맵 이름
    ...
    preload() {
        this.load.image("cemetery_end_north", "/static/assets/map/cemetery_end_north.png");
        this.load.tilemapTiledJSON('cemetery_end_northTile', '/static/assets/map/cemetery_end_north1.json');
        // BGM
    ...
    create() {
        ...
        const map = this.add.image(0, 0, "cemetery_end_north").setOrigin(0);
        const tile = this.make.tilemap({ key: 'cemetery_end_northTile' });
