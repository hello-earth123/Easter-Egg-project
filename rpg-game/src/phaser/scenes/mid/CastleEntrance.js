...
export default class CastleEntrance extends Phaser.Scene {
    ...
    constructor() {
        super({ key: "CastleEntrance" });

        this.mapKey = "CastleEntrance";

        this.mapName = "성 입구";      // 맵 이름
    ...
    preload() {
        this.load.image("castle_entrance", "/static/assets/map/castle_entrance.png");
        this.load.tilemapTiledJSON('castle_entranceTile', '/static/assets/map/castle_entrance.json');
        // BGM
    ...
    create() {
        ...
        // 1. 씬 BGM
        this.SoundManager.playBgm("bgm_castle_entrance")
        ...
        const map = this.add.image(0, 0, "castle_entrance").setOrigin(0);
        const tile = this.make.tilemap({ key: 'castle_entranceTile' });
        ...
        // 포탈 4개 생성
        this.portals = {
            east: this.physics.add.sprite(1280, 380, "portal"),
